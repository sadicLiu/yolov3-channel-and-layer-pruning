...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-tiny-1branch-256-quant-thick128.cfg',
                        help='cfg file path')
    ...
    parser.add_argument('--weights', type=str, default='weights/last.weights',
